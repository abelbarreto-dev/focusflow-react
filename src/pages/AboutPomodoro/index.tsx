    ...
    <PageTemplate>
        <Container>
            <GenericHtml>
                ...
                <p>
                    A Técnica Pomodoro é uma metodologia de produtividade criada
                    por <strong>Francesco Cirillo</strong>, que consiste em
                    dividir o trabalho em blocos de tempo (os famosos
                    "Pomodoros") intercalados com pausas. O objetivo é manter o
                    foco total por um período curto e garantir descansos para
                ...
                <p>
                    ...
                    melhorias e personalizações pra deixar o processo ainda mais
                    eficiente:
                </p>
                ...
                <ul>
                    ...
                    <li>
                        Ciclo <strong>8</strong>: Descanso longo especial, pra
                        resetar o ciclo completo.
                    </li>
                </ul>
                ...
                <p>
                    Assim, você sempre sabe em que parte do processo está e o
                    que vem a seguir. Não precisa mais anotar no papel ou ficar
                ...
                <p>
                    ...
                    interrompidas. Assim, você consegue acompanhar sua evolução
                    ao longo do tempo.
                </p>
